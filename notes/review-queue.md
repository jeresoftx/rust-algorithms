...
| --- | --- | --- | --- | --- |
| Minimum Window Substring | Sliding window | Ventana y conteos suelen romperse al contraer | pendiente | 2026-07-16 |
| Validate Binary Search Tree | Árboles | Requiere límites heredados, no solo comparar padre | pendiente | 2026-07-20 |
| Course Schedule | Grafos | Topological sort y ciclos dirigidos | pendiente | 2026-07-23 |
