# Semanas 09 y 10: Trees

## Objetivo

Dominar DFS, BFS y recursión sobre árboles binarios, incluyendo validación de BST, ancestor search y construcción desde recorridos.
...
| Validate Binary Search Tree | DFS con límites | `is_valid_bst` | 2 |
