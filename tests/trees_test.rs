...
#[test]
fn recover_binary_search_tree_restores_swapped_inorder_values() {
    let tree = tree_from_level_order(vec![Some(3), Some(1), Some(4), None, None, Some(2)]);
    recover_binary_search_tree(&tree);
    assert_eq!(
