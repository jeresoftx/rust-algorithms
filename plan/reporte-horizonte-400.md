...
| Aspecto | Estado |
| --- | --- |
| Catálogo funcional | 193 problemas implementados y probados. |
| Familias de patrones | 19 módulos de patrones. |
| Tests automatizados | 465 pruebas deterministas/property y 9 doctests. |
...
Is Subsequence y Merge Sorted Array (candidatos 192-194) elevaron el conteo de
190 a 193.
...
- Los candidatos 195-400 todavía no son implementaciones funcionales nuevas.
