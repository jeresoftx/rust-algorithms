...
| Aspecto | Estado |
| --- | --- |
| Catálogo funcional | 198 problemas implementados y probados. |
| Familias de patrones | 19 módulos de patrones. |
| Tests automatizados | 480 pruebas deterministas/property y 9 doctests. |
...
y Baseball Game, Remove Duplicates from Sorted Array II y Sort Colors
(candidatos 192-195 y 197-200) elevaron el conteo de 190 a 198.
...
- Los candidatos 196 y 201-400 todavía no son implementaciones funcionales nuevas.
