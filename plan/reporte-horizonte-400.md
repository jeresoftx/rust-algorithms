...
| Aspecto | Estado |
| --- | --- |
| Catálogo funcional | 199 problemas implementados y probados. |
| Familias de patrones | 19 módulos de patrones. |
| Tests automatizados | 484 pruebas deterministas/property y 9 doctests. |
...
Continuous Subarray Sum (candidatos 192-195, 197-200 y 202) elevaron el
conteo de 190 a 199.
...
- Los candidatos 196 y 203-400 todavía no son implementaciones funcionales nuevas.
