...
| Aspecto | Estado |
| --- | --- |
| Catálogo funcional | 197 problemas implementados y probados. |
| Familias de patrones | 19 módulos de patrones. |
| Tests automatizados | 478 pruebas deterministas/property y 9 doctests. |
...
y Baseball Game, y Remove Duplicates from Sorted Array II (candidatos 192-195
y 197-199) elevaron el conteo de 190 a 197.
...
- Los candidatos 196 y 200-400 todavía no son implementaciones funcionales nuevas.
