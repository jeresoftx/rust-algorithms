...
| Aspecto | Estado |
| --- | --- |
| Catálogo funcional | 194 problemas implementados y probados. |
| Familias de patrones | 19 módulos de patrones. |
| Tests automatizados | 469 pruebas deterministas/property y 9 doctests. |
...
Is Subsequence, Merge Sorted Array y Find Pivot Index (candidatos 192-195)
elevaron el conteo de 190 a 194.
...
- Los candidatos 196-400 todavía no son implementaciones funcionales nuevas.
