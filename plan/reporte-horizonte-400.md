...
| Aspecto | Estado |
| --- | --- |
| Catálogo funcional | 204 problemas implementados y probados. |
| Familias de patrones | 19 módulos de patrones. |
| Tests automatizados | 494 pruebas deterministas/property y 9 doctests. |
...
202-205, 207 y 209) elevaron el conteo de 190 a 204.
...
- Los candidatos 196, 206, 208 y 210-400 todavía no son implementaciones funcionales nuevas.
